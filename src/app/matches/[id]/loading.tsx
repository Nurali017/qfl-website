        ...
        <div className="max-w-[1440px] mx-auto px-4">
          <div className="flex gap-8 py-4">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="animate-pulse bg-gray-200 dark:bg-dark-surface-soft h-8 w-24 rounded"
              />
            ))}
          </div>
        </div>
      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="animate-pulse bg-gray-200 dark:bg-dark-surface-soft h-96 rounded-2xl" />
          </div>
          <div>
