...
export default function MatchesPage() {
  ...
  const showScheduleNotice = effectiveSeasonId === 200;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 pb-8">
        {showScheduleNotice && (
          <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-700/70 dark:bg-amber-900/25 dark:text-amber-100">
            {t('scheduleNotice.global')}
          </div>
        )}
        <MatchCenter />
      </div>
