    ...
    <div className="max-w-[1400px] mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-dark-surface rounded-2xl p-8 mb-8">
        <div className="flex gap-8">
          {/* Player photo */}
          <div className="animate-pulse bg-gray-200 dark:bg-slate-700 w-48 h-48 rounded-2xl" />

          {/* Player info */}
          <div className="flex-1">
            <div className="animate-pulse bg-gray-200 dark:bg-slate-700 h-8 w-64 rounded mb-4" />
            <div className="animate-pulse bg-gray-200 dark:bg-slate-700 h-5 w-48 rounded mb-6" />
            ...
            <div className="flex gap-6">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 w-24"
                >
                  <div className="animate-pulse bg-gray-200 dark:bg-slate-700 h-8 w-12 rounded mb-2 mx-auto" />
                  <div className="animate-pulse bg-gray-200 dark:bg-slate-700 h-4 w-16 rounded mx-auto" />
                </div>
              ))}
            </div>
          </div>
