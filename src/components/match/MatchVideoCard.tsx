      ...
      <div className="relative aspect-video bg-gray-900">
        {isPlaying && youtubeId ? (
          ...
          >
            ...
            <button className="relative z-10 w-20 h-20 rounded-full bg-red-600 hover:bg-red-700 hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center shadow-[0_0_30px_rgba(220,38,38,0.5)]">
              <Play className="w-8 h-8 text-white fill-white ml-1" />
              <span className="absolute -inset-4 rounded-full border-2 border-white/20 animate-ping opacity-20" />
            </button>
          </div>
        )}
      </div>
