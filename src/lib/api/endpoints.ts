...
export const ENDPOINTS = {
  ...
  MATCH_DETAIL: (id: number) => `/games/${id}`,
  MATCH_STATS: (id: number) => `/games/${id}/stats`,
  MATCH_LINEUP: (id: number) => `/games/${id}/lineup`,
  MATCH_EVENTS: (id: number) => `/live/events/${id}`,
  PLAYER_DETAIL: (id: number) => `/players/${id}`,
  PLAYER_MATCHES: (id: number) => `/players/${id}/games`,
  PLAYER_STATS: (id: number) => `/players/${id}/stats`,
  PLAYER_TEAMMATES: (id: number) => `/players/${id}/teammates`,
  PLAYER_TOURNAMENTS: (id: number) => `/players/${id}/tournaments`,
  TEAMS: '/teams',
  TEAM_DETAIL: (id: number) => `/teams/${id}`,
  TEAM_OVERVIEW: (id: number) => `/teams/${id}/overview`,
